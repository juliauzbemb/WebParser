...
HEADERS = {'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,'
           ...
           'Cookie':
               '_ym_uid=1639934666860889724; _ym_d=1639934666; _ga=GA1.2.122808168.1639934666; '
               '_gid=GA1.2.1540720803.1639934666; '
               'habr_web_home=ARTICLES_LIST_ALL; hl=ru; fl=ru; _ym_isad=2; '
               '__gads=ID=3bca2fb12a84bfaa:T=1639934668:S=ALNI_MagABWot_b98koFdCB4lM3aLC2RAA; '
               'cto_bundle'
               '=0wD_ ',
           'Host': 'habr.com',
